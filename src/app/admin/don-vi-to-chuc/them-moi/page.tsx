...
export default function ThemMoiDonViPage() {
  ...
  useEffect(() => {
    document.title = "Thêm mới Đơn vị | QLCNC";
    fetchDonViList();
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await donViApi.create(payload);
      
      Swal.fire({
        icon: "success",
        title: "Thành công!",
        text: "Thêm đơn vị mới thành công",
        timer: 1500,
      ...
      Swal.fire({
        icon: "error",
        title: "Lỗi!",
        text: error.message || "Có lỗi xảy ra khi thêm đơn vị",
      });
    } finally {
      setLoading(false);
    }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">
            Thêm đơn vị, phòng ban mới vào hệ thống
          </p>
        </div>
        <Link
