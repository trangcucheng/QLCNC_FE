...
export default function BaoCaoPage() {
  ...
  useEffect(() => {
    document.title = "Báo cáo & Thống kê | QLCNC";
  }, []);
  ...
  const handleExportTongHop = async () => {
    try {
      ...
      showInfo("Đã tải dữ liệu báo cáo! (Cần tích hợp xuất file)");
    } catch (error) {
      console.error("Lỗi khi xuất báo cáo:", error);
      showError("Có lỗi khi xuất báo cáo!");
    }
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h5 className="text-3xl font-bold text-gray-900">Báo Cáo Chi Tiết</h5>
